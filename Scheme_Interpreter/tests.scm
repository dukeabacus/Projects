...
'(1 (2 this makes no sense . 4))
; expect (1 (2 this makes no sense . 4))

(define (mul_twenty x) (* x 20)) (mul_twenty 9)
; expect 180

(define positive? (lambda (x) (if (> x 0) True False))) (positive? (- 1 8))
; expect False

(define (cddr s) (cdr (cdr (cdr s))))
...
(let ((x (lambda (y) (* y (* y (- y 1))))) (y 5)) (x y))
; expect 100

(define alpha (mu (x y z k l) (* a b) ))
(define beta (lambda (a b) (alpha (* a b) a b a b)))
(beta 3 6)
; expect 18
...
(define (create_list ch) (lambda (s) (list s ch)))
; expect create_list

((create_list "world!") "hello")
; expect ("hello" "world!")
...
(cons (cons (cons (cons 3 nil) nil) nil) nil)
; expect ((((3))))

(cons (list 1 2 3 4) (list 1 2 3 4))
